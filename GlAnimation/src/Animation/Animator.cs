...
namespace animation
{
	 ...
	 */
		public void update ()
		{
			...
			Dictionary<String, Matrix4f> currentPose = calculateCurrentAnimationPose ();
	 ...
	 */
		...
		{
			animationTime += AnimationApp.time;
	 ...
	 */
		private Dictionary<String, Matrix4f> interpolatePoses (KeyFrame previousFrame, KeyFrame nextFrame, float progression)
		{
			Dictionary<String, Matrix4f> currentPose = new Dictionary<String, Matrix4f> ();
